...
import com.ahmad.cv.fragments.ProjectFragment;
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(R.drawable.noorish).into(profileImage);
        ...
        mViewPagerAdapter.addFragment(ProjectFragment.newInstance(), "");
    ...
    private void setupTabIcons() {
       final int[] tabIcons = {
                ...
                R.drawable.ic_laptop_black_24dp,
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tab.getPosition() == 0) {
                    Objects.requireNonNull(tab.getIcon()).setColorFilter(Color.parseColor("#fc641b"), PorterDuff.Mode.SRC_IN); }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                    Objects.requireNonNull(tab.getIcon()).setColorFilter(Color.parseColor("#0c447d"), PorterDuff.Mode.SRC_IN);
            }
            @Override
